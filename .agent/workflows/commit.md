---
description: Commit krusch-dbos-mcp changes and push to GitHub
---

# /commit — krusch-dbos-mcp

> krusch-dbos-mcp has its own git remote (`git@github.com:kruschdev/krusch-dbos-mcp.git`) separate from the homelab monorepo.
