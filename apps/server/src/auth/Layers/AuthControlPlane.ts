import type { AuthClientSession, AuthPairingLink } from "@kd/contracts";
...
export const AuthStorageLive = Layer.mergeAll(ServerSecretStoreLive, PgPersistenceLayerLive);
