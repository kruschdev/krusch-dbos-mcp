...
import { GitCommandError, type GitBranch } from "@kd/contracts";
import { dedupeRemoteBranchesWithLocalMatches } from "@kd/shared/git";
...
import { decodeJsonResult } from "@kd/shared/schemaJson";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `kdcode-git-trace2-${process.pid}-`,
    suffix: ".json",
  });
