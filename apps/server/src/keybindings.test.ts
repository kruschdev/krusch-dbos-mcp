import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@kd/contracts";
...
import { KeybindingsConfigError } from "@kd/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "kdcode-keybindings-test-",
        }),
      ),
    ),
  );
