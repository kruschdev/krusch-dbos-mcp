...
import { EDITORS, OpenError, type EditorId } from "@kd/contracts";
import { isCommandAvailable, type CommandAvailabilityOptions } from "@kd/shared/shell";
...
export { OpenError };
export { isCommandAvailable } from "@kd/shared/shell";
