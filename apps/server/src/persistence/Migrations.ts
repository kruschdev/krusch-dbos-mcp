...
import Migration0026 from "./Migrations/026_OrchestrationCommandQueue.ts";
import Migration0027 from "./Migrations/027_OrchestrationEventEmbeddings.ts";
import Migration0028 from "./Migrations/028_AgentExecutionQueue.ts";
import Migration0029 from "./Migrations/029_OrchestrationEventEmbeddingsProjectId.ts";
import Migration0030 from "./Migrations/030_OrchestrationNuggets.ts";
import Migration0031 from "./Migrations/031_AddTurnIdToProjectionThreadMessages.ts";
...
export const migrationEntries = [
  ...
  [26, "OrchestrationCommandQueue", Migration0026],
  [27, "OrchestrationEventEmbeddings", Migration0027],
  [28, "AgentExecutionQueue", Migration0028],
  [29, "OrchestrationEventEmbeddingsProjectId", Migration0029],
  [30, "OrchestrationNuggets", Migration0030],
  [31, "AddTurnIdToProjectionThreadMessages", Migration0031],
] as const;
