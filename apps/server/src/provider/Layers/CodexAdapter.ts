...
import { Effect, Exit, Fiber, FileSystem, Layer, Option, Queue, Schema, Scope, Stream } from "effect";
...
const makeCodexAdapter = Effect.fn("makeCodexAdapter")(function* (
  ...
  const sendTurn: CodexAdapterShape["sendTurn"] = Effect.fn("sendTurn")(function* (originalInput) {
