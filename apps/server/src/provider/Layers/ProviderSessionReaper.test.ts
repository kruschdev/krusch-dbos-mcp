...
import { ProjectId, ThreadId, TurnId } from "@kd/contracts";
...
describe("ProviderSessionReaper", () => {
  let runtime: ManagedRuntime.ManagedRuntime<
    ProviderSessionReaper | ProviderSessionRuntimeRepository | SqlClient.SqlClient,
    unknown
  > | null = null;
  ...
  async function createHarness(input: {
    ...
    const runtimeRepositoryLayer = ProviderSessionRuntimeRepositoryLive;
