import type { GitStatusRemoteResult, GitStatusResult } from "@kd/contracts";
...
describe("normalizeGitRemoteUrl", () => {
  it("canonicalizes equivalent GitHub remotes across protocol variants", () => {
    expect(normalizeGitRemoteUrl("git@github.com:kruschdev/KDCode.git")).toBe(
      "github.com/kruschdev/kdcode",
    );
    expect(normalizeGitRemoteUrl("https://github.com/kruschdev/KDCode.git")).toBe(
      "github.com/kruschdev/kdcode",
    );
    expect(normalizeGitRemoteUrl("ssh://git@github.com/kruschdev/KDCode")).toBe(
      "github.com/kruschdev/kdcode",
    );
  });

  it("preserves nested group paths for providers like GitLab", () => {
    expect(normalizeGitRemoteUrl("git@gitlab.com:kruschdev/platform/KDCode.git")).toBe(
      "gitlab.com/kruschdev/platform/kdcode",
    );
    expect(normalizeGitRemoteUrl("https://gitlab.com/kruschdev/platform/KDCode.git")).toBe(
      "gitlab.com/kruschdev/platform/kdcode",
    );
  });
...
describe("parseGitHubRepositoryNameWithOwnerFromRemoteUrl", () => {
  it("extracts the owner and repository from common GitHub remote shapes", () => {
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("git@github.com:kruschdev/KDCode.git"),
    ).toBe("kruschdev/KDCode");
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("https://github.com/kruschdev/KDCode.git"),
    ).toBe("kruschdev/KDCode");
  });
});
